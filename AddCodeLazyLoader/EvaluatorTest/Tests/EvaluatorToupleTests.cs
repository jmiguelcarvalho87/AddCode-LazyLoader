...
namespace EvaluatorTest
{
    ...
    public class EvaluatorToupleTests
    {
        [TestMethod]
        [Benchmark]
        public void Evaluator_Touple_Should_Return_22()
        {
            // Arrange
            int expected = 22;
            int seed = 8;
        ...
        //[TestMethod]
        //[Benchmark]
        //public void Evaluate_for_bool_with_seed_TRUE_plus_TRUE_and_FALSE_as_additionalArgs_for_the_same_function_returns_FALSE()
        //{
        //    // Arrange
        //    bool seed = true;
        //    bool expected = true;
        ...
        //    //Act
        //    evaluator.Add((val, additionalVals) => val && additionalVals[0], true);

        //    //evaluator.Add((val, additionalVals) => additionalVals.Aggregate(val, (v1, v2) => v1 && v2), true, false);
