...
namespace EvaluatorTests
{
    ...
    public class EvaluatorQueueTests
    {
        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_For_Int_Should_Return_22()
        {
            // Arrange
            int expected = 22;
            int seed = 8;
            ...
            EvaluatorQueue<int> evaluator = new EvaluatorQueue<int>();
            ...
            // Assert
            Assert.AreEqual(expected, finalResult, "Final int result is wrong");
        }

        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_Should_Return_AddCode_Challenge_Is_Working_Nicely()
        {
            // Arrange
            string seed = "AddCode";
            ...
            EvaluatorQueue<string> evaluator = new EvaluatorQueue<string>();
            ...
            // Assert
            Assert.AreEqual("AddCode challenge is working nicely", finalResult, "Final string result is wrong");
        }

        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_With_No_Function_Returns_Seed()
        {
            // Arrange
            int seed = 2;
            int expected = seed;
            var evaluator = new EvaluatorQueue<int>();
        ...
        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_For_Double_With_Seed_5_And_Function_Power_Of_2_With_No_Additional_Arg_Returns_25()
        {
            // Arrange
            int seed = 5;
            int expected = 25;
            var evaluator = new EvaluatorQueue<double>();
        ...
        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_For_Boolean_With_Seed_TRUE_And_Additional_Args_TRUE_And_False_Should_Return_FALSE()
        {
            // Arrange
            bool seed = true;
            bool expected = false;
            var evaluator = new EvaluatorQueue<bool>();
        ...
        [TestMethod]
        [Benchmark]
        public void Evaluator_Queue_Add_Null_Function_Throws_ArgumentNullException()
        {
            // Arrange
            var evaluator = new EvaluatorQueue<int>();
